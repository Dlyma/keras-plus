...
def build_model():
    ...
    model.add(DEEPLSTM(input_dim=1, output_dim=hidden_units,init='glorot_normal', num_blocks=nb_blocks, return_seq_num=0, truncate_gradient=tg))
    #model.add(Dropout(0.5))
    model.add(TimeDistributedDense(hidden_units*nb_blocks, 1))
